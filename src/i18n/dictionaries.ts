...
export const dictionaries: Record<Locale, Dictionary> = {
  zh: {
    ...
    home: {
      ...
      subtitle: "访客看公开内容，普通、黄金、钻石用户按权限浏览。邀请码决定初始等级，你也可以在管理页调整。",
      latest: "最新内容",
    ...
    admin: {
      ...
      memberAccounts: "会员账号",
      publishWorkspace: "发布内容",
      publishWorkspaceHint: "先选内容类型和可见等级，再上传素材，最后发布或保存。",
      contentPreview: "实时预览",
      contentPreviewHint: "预览会随着表单输入实时变化。",
      mediaWorkflow: "素材上传",
      ...
      contentTagsHint: "标签会用于前台筛选和管理搜索。",
    ...
    admin: {
      ...
      users: "Users",
      uploadImages: "Upload image assets",
      ...
      contentTagsHint: "Tags power public filters and management search.",
